...
class LBRecommendLiveCell: UICollectionViewCell {
    ...
    private lazy var replicatorLayer: ReplicatorLayer = {
        let layer = ReplicatorLayer.init(frame: CGRect.init(x: 0, y: 0, width: 2, height: 15))
        return layer
    }()
    ...
    func setUpUI() {
        ...
        self.categoryL.snp_makeConstraints { (make) in
        ...
        self.replicatorLayer.snp_makeConstraints { (make) in
