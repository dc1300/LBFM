...
class LBFMPlayDetailProgramCell: UITableViewCell {
    ...
    func setUpLayout() {
        ...
        self.playImage.snp_makeConstraints { (make) in
            make.left.equalTo(self.titleLabel)
            make.bottom.equalTo(-15)
            make.width.height.equalTo(17)
        }
        self.addSubview(self.playCountLabel)
        self.playCountLabel.text = "141万"
        self.playCountLabel.snp_makeConstraints { (make) in
        ...
        self.commentImage.snp_makeConstraints { (make) in
        ...
        self.commentNumLabel.snp_makeConstraints { (make) in
